    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumb', models.ImageField(upload_to='thumb_field')),
                ('descricao', models.TextField(max_length=10000)),
                ('categoria', models.CharField(choices=[('ANALISE', 'Análises'), ('PROGRAMACAO', 'Programação'), ('ORGANIZACAO', 'Organização'), ('APRESENTACAO', 'Apresentação'), ('OUTROS', 'Outros')], max_length=16)),
